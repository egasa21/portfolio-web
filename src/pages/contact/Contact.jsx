    ...
    return (
        <section id="contact" className="mx-auto max-w-7xl py-20 p-6 lg:px-8">
            ...
            <div className="mt-12 text-center text-gray-700">
                <p className="text-lg">Or reach out via email: <a href="mailto:esaputra168@gmail.com" className="font-semibold hover:text-teal-600 transition-colors">esaputra168@gmail.com</a></p>
